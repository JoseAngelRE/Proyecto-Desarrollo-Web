      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item cosa">
              <a class="nav-link activa" href="imcPagina.html">Calcula tu IMC</a>
            </li>
            <li class="nav-item cosa"> 
          ...
          <form action="">
            ...
            <section class="campoX pesoEstatura">
              <div class="campito">
                ...
                >
                <input class="cajaInput" type="text" placeholder="Peso" id="peso" />
              </div>
              ...
              <div class="campito">
                ...
                >
                <input class="cajaInput" type="text" placeholder="Altura" id="altura" />
              </div>
            </section>
            <input type="button" value="CALCULAR" id="btnSubmit" onclick="calculaesIMC()"/>
          </form>
        </section>
...
function calculaesIMC()
	{
		...
		var peso2, altura, imc, imc2, img, des, leyenda;
